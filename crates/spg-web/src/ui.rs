...
const ASSET_VERSION: &str = concat!(env!("CARGO_PKG_VERSION"), "-wireframe");
        ...
        view! {
            <html lang="zh-CN">
                ...
                <body class="page-shell page-galaxy">
                    ...
                    <script type="module" src=format!("/assets/galaxy_wire.js?v={ASSET_VERSION}")></script>
                </body>
            </html>
        }
    });
